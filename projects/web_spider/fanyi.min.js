...
function(e, t) {
    ...
    b = {
        ...
        skin: 0,
        placeholder: {
            account: "é‚®ç®±å¸å·æˆ–æ‰‹æœºå·",
            pwd: "6-16ä½å¯†ç ï¼ŒåŒºåˆ†å¤§å°å†™"
        },
        needPrepare: 1,
        needanimation: 1,
...
function(e, t) {
    t.errorMsg = {
        10 : "æŠ±æ­‰ï¼Œä¸ªåˆ«å¥å­å¤ªé•¿å•¦ï¼Œæˆ‘è¯»ä¸æ‡‚",
        20 : "æŠ±æ­‰ï¼Œè¶…è¿‡5000å­—å®žåœ¨å¤ªé•¿å•¦ï¼Œè®©æˆ‘å–˜å£æ°”",
        30 : "æŠ±æ­‰ï¼Œæˆ‘ç»žå°½è„‘æ±äº†",
        40 : "æŠ±æ­‰ï¼Œæˆ‘è¿˜åœ¨å­¦ä¹ è¯¥è¯­ç§ä¸­",
        50 : "æŠ±æ­‰ï¼Œè¯·ä¸è¦é¢‘ç¹è¯·æ±‚æœåŠ¡",
        transRequestError: "ç¿»è¯‘å‡ºé”™ï¼Œè¯·æ£€æŸ¥ç½‘ç»œåŽé‡è¯•"
    }
}),
        ...
        function() {
            ...
            if (h.switchMode(!0), t.isDocMode = !0, t.isDocReady = !1, p("#docLangTip").show(), e && e[0] && e[0].size && (n = e[0].size), "" != (i = e && e[0] && e[0].name ? e[0].name: i.split("\\")[i.split("\\").length - 1])) {
                if (!/(.docx|.pdf)$/i.test(i)) return o(!0, {
                    msg: "æ ¼å¼é”™è¯¯ï¼Œè¯·ä½¿ç”¨docxï¼pdfæ ¼å¼",
                    name: i,
                    size: r(n)
                }),
...
function(e, t) {
    ...
    function a(e) {
        if (0 == f('li[data-value="' + e + '"]').length) f("#langSelect").selectValue("AUTO");
            ...
            O.state.isSelectLan || f(".select-text").text("æ£€æµ‹åˆ°ï¼š" + t)
        }
    }
    function s(e) {
    ...
    t.translate = function(e, t) {
        ...
        if (F(), T.text(i), i > 5e3) {
            ...
            f("#inputTargetError").text("æœ‰é“ç¿»è¯‘å­—æ•°é™åˆ¶ä¸º5000å­—ï¼Œâ€œ" + s + "â€åŠå…¶åŽé¢æ²¡æœ‰è¢«ç¿»è¯‘!").show(),
